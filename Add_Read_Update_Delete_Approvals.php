...
$usersQuery = $conn->query("SELECT first_name, last_name, user_email, approved FROM logincredentials WHERE user_role = 'staff'");
...
if (isset($_POST['user_email'])) 
{
    ...
    header("Location: Add_Read_Update_Delete_Approvals.php");
    exit;
}
