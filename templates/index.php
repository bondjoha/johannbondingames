...
$countryToUse = $country ?: ($_SESSION['selected_country'] ?? '');

// Fetch cities only if the country is valid
if (!empty($countryToUse))
{
    $stmt = $conn->prepare
    ("
